...
""" Importa la clase base declarativa (Base) desde tu archivo database.py.
Es el punto de partida para definir modelos.
...
class GameSession(Base):
    ...
    id = Column(Integer, primary_key=True, index=True, autoincrement=True)
    user_id = Column(Integer, ForeignKey("users.id")) # (1:N) un usuario puede tener múltiples sesiones de juego
